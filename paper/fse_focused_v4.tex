...
checks to save money drops exactly the faults that need a specific probe---across
three seeds the shortest checklist catches strictly fewer faults than the full one
on every seed, and detection also \emph{destabilizes} (from 4--5 of 5 caught at
full to 1--4 at the tightest cap)---while overhead never reaches 12\%. The coupling
